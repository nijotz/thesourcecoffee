...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'subscriptions_subscription', 'status')

        # Adding field 'Subscription.paused'
        db.add_column(u'subscriptions_subscription', 'paused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Subscription.stripe_status'
        db.add_column(u'subscriptions_subscription', 'stripe_status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Subscription.status'
        db.add_column(u'subscriptions_subscription', 'status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=25),
                      keep_default=False)

        # Deleting field 'Subscription.paused'
        db.delete_column(u'subscriptions_subscription', 'paused')

        # Deleting field 'Subscription.stripe_status'
        db.delete_column(u'subscriptions_subscription', 'stripe_status')
